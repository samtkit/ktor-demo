...
fun `encode Greeting`(record: tools.samt.server.generated.greeter.Greeting): JsonObject {
...
fun `encode Complex`(record: tools.samt.server.generated.greeter.Complex): JsonObject {
    // Encode field name
    val `field name` = run {
...
fun `decode Complex`(json: JsonElement): tools.samt.server.generated.greeter.Complex {
    // Decode field name
    val `field name` = run {
    ...
    return tools.samt.server.generated.greeter.Complex(
        name = `field name`,
        age = `field age`,
    )
}
...
fun `encode GreetingType`(value: tools.samt.server.generated.greeter.GreetingType) = when(value) {
    tools.samt.server.generated.greeter.GreetingType.HELLO -> "HELLO"
    tools.samt.server.generated.greeter.GreetingType.HI -> "HI"
    tools.samt.server.generated.greeter.GreetingType.HEY -> "HEY"
